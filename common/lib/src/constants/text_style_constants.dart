...
const kCaptionActiveTextStyle = TextStyle(fontSize: kCaptionTextSize, color: Colors.black);

const kCaptionInactiveTextStyle = TextStyle(fontSize: kCaptionTextSize, color: kInactiveSecondaryColor);
